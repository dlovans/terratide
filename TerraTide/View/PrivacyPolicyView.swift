    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 10) {
                ...
                **5. Age Restrictions**
                TerraTide requires users to be at least **17 years old** to use the app. Users will be divided into **adults** and **non-adults** based on the date of birth they provide during registration. Users who are under 18 years old will not be able to access adult content (+18). 

                We do not knowingly collect personal data from children under 17. If we learn that we have collected personal data from a child under 17, we will take steps to delete such data.
